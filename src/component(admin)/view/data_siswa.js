      ...
      <Modal
        ...
        onSubmit={(form) => {
          ...
          if (props.modalName === "insert") {
            endpoint = "http://localhost/amin/Project-UKS/backend/proses/proses_tambah.php?type=siswa";
            ...
            endpoint = "http://localhost/amin/Project-UKS/backend/proses/proses_hapus.php?type=siswa";
