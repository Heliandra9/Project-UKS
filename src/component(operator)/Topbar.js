            ...
            {showMenu && (
                <div className="md:hidden bg-green-600 px-4 pb-3 space-y-3">
                    <button
                        ...
                        className={`${navBtn} block w-full text-left ${view === "tambah" ? activeBtn : normalBtn
                            }`}
                    >
                        Tambah Pasien
                    </button>
                    <button
                        ...
                        className={`${navBtn} block w-full text-left ${view === "kunjungan" ? activeBtn : normalBtn
                            }`}
                    >
                        Kunjungan
                    </button>
